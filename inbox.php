        ...
        <div class="row"  >
             ...
             <?php
                 ...
                 <!-- start  by me --> 
                   <li class="by-me margin-bottom-10" >
                      ...
                      <div class="content" >
                         <div class="chat-meta" > <?php echo $chat['UserName'] ?> <span class="pull-right"> <?php echo $chat['time'] ?> </span></div>
            ...
            <div class="right-item  overflow-auto col-lg-4 col-md-6 col-sm-12" >
                <?php foreach($infos as $info){ 
                        ...
                        $stmt = $con->prepare("SELECT * FROM user WHERE UserID=". $info['other']."");
                        $stmt->execute();
                        $user = $stmt->fetch();    
                ...
                ?>
                <a href="inbox.php?friend=<?php echo $user['UserID'];?>" >
                    <div  <?php if($info['other']==$other){ echo "style='background-color:#ddd;'"; }  ?> class="row users-messages text-right"> 
                        <div class="col-md-8 user-item" > 
                            <h6 style="direction:rtl;color:#286090;font-weight: 700;font-size:20px;margin:0" > <?php echo $user['UserName']  ?>  </h6> 
                        ...
                        <div class="col-md-4 user-img" >
                            <img class="img-fluid img-thumbnail mx-auto" src="img.jpg" >
                        </div>
                    </div> 
                </a> 
                <?php }?>
